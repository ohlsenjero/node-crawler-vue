<template>
  <div v-bind:show="todos.length>0" class="float-left list-div">
    <div class="form-row align-items-left" v-for="todo in todos">
...
export default {
  ...
  methods: {
    fetchTodo() {
      ...
      // let uriSplit= uri.href.split("/");
      // let getUri = uriSplit.pop();
      //alert(getUri);
      this.$http.get("/crawl").then(response => {
